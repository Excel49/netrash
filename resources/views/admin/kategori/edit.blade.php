...
@section('title', 'Edit Kategori Sampah - Admin')

@section('header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="h3 mb-0">Edit Kategori Sampah</h1>
...
@section('content')
    ...
    <select class="form-select @error('jenis_sampah') is-invalid @enderror" 
        ...
        <option value="organik" {{ old('jenis_sampah', $kategori->jenis_sampah) == 'organik' ? 'selected' : '' }}>Organik</option>
        <option value="anorganik" {{ old('jenis_sampah', $kategori->jenis_sampah) == 'anorganik' ? 'selected' : '' }}>Anorganik</option>
        <option value="berbahaya" {{ old('jenis_sampah', $kategori->jenis_sampah) == 'berbahaya' ? 'selected' : '' }}>Bahan Berbahaya</option>
        <option value="daur_ulang" {{ old('jenis_sampah', $kategori->jenis_sampah) == 'daur_ulang' ? 'selected' : '' }}>Daur Ulang</option>
        <option value="lainnya" {{ old('jenis_sampah', $kategori->jenis_sampah) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
    </select>
    @error('jenis_sampah')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" 
                                       ...
                                       id="warna_label" 
                                       name="warna_label" 
                                       value="{{ old('warna_label', $kategori->warna_label) }}" 
